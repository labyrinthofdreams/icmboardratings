...
:: Diffs Dir contains previous versions of CSV rating lists that are compared
:: against to determine how much the positions have changed.
:: These lists should contain ALL the films in that category.
:: Ex: features-all-asc.csv should contain ALL feature films, not just top 1000
SET diffsdir=archive\%3
...
--limit-voters-min 5 --limit-titletype feature --sort-by dmean ayear atitle --diffs-file %diffsdir%\features-all-asc.csv
...
--limit-voters-min 5 --limit-titletype feature --sort-by dmean ayear atitle --diffs-file %diffsdir%\features-all-asc.csv --discard 1000
...
--limit-voters-min 5 --limit-titletype docu --sort-by dmean ayear atitle --diffs-file %diffsdir%\docus-all-asc.csv
...
--limit-voters-min 5 --limit-titletype short --sort-by dmean ayear atitle --diffs-file %diffsdir%\shorts-all-asc.csv
...
--limit-voters-min 5 --limit-titletype feature --sort-by amean dyear dtitle --diffs-file %diffsdir%\features-all-desc.csv
...
--diffs-file %diffsdir%\features-all-asc.csv
...
--diffs-file %diffsdir%\features-all-desc.csv
...
--diffs-file %diffsdir%\docus-all-asc.csv
...
--diffs-file %diffsdir%\shorts-all-asc.csv
...
ECHO Generating new entry CSV files
python csv_new.py %diffsdir%\top1000features.raw.csv %basedir%\top1000features.raw.csv %basedir%\top1000features.new.raw.csv
python csv_new.py %diffsdir%\top1001-2000features.raw.csv %basedir%\top1001-2000features.raw.csv %basedir%\top1001-2000features.new.raw.csv
python csv_new.py %diffsdir%\bottom100features.raw.csv %basedir%\bottom100features.raw.csv %basedir%\bottom100features.new.raw.csv
python csv_new.py %diffsdir%\top200docus.raw.csv %basedir%\top200docus.raw.csv %basedir%\top200docus.new.raw.csv
python csv_new.py %diffsdir%\top200shorts.raw.csv %basedir%\top200shorts.raw.csv %basedir%\top200shorts.new.raw.csv

python csv_strip.py %basedir%\top1000features.new.raw.csv %basedir%\top1000features.new.csv
python csv_strip.py %basedir%\top1001-2000features.new.raw.csv %basedir%\top1001-2000features.new.csv
python csv_strip.py %basedir%\bottom100features.new.raw.csv %basedir%\bottom100features.new.csv
python csv_strip.py %basedir%\top200shorts.new.raw.csv %basedir%\top200shorts.new.csv
python csv_strip.py %basedir%\top200docus.new.raw.csv %basedir%\top200docus.new.csv

ECHO Generating dropped entry CSV files
python csv_dropped.py %diffsdir%\top1000features.raw.csv %basedir%\top1000features.raw.csv ^
%basedir%\features-all-asc.csv %basedir%\top1000features.dropped.raw.csv
python csv_dropped.py %diffsdir%\top1001-2000features.raw.csv %basedir%\top1001-2000features.raw.csv ^
%basedir%\features-all-asc.csv %basedir%\top1001-2000features.dropped.raw.csv
python csv_dropped.py %diffsdir%\bottom100features.raw.csv %basedir%\bottom100features.raw.csv ^
%basedir%\features-all-desc.csv %basedir%\bottom100features.dropped.raw.csv
python csv_dropped.py %diffsdir%\top200docus.raw.csv %basedir%\top200docus.raw.csv ^
%basedir%\docus-all-asc.csv %basedir%\top200docus.dropped.raw.csv
python csv_dropped.py %diffsdir%\top200shorts.raw.csv %basedir%\top200shorts.raw.csv ^
%basedir%\shorts-all-asc.csv %basedir%\top200shorts.dropped.raw.csv

python csv_strip.py %basedir%\top1000features.dropped.raw.csv %basedir%\top1000features.dropped.csv
python csv_strip.py %basedir%\top1001-2000features.dropped.raw.csv %basedir%\top1001-2000features.dropped.csv
python csv_strip.py %basedir%\bottom100features.dropped.raw.csv %basedir%\bottom100features.dropped.csv
python csv_strip.py %basedir%\top200docus.dropped.raw.csv %basedir%\top200docus.dropped.csv
python csv_strip.py %basedir%\top200shorts.dropped.raw.csv %basedir%\top200shorts.dropped.csv
